...
<div class="th1">名前</div>
<div class="th2">年齢</div>
<div class="th3">Eメール</div>
<div class="th3">住所</div>
<?php
session_start();
$pdo=new PDO('mysql:host=localhost;dbname=gs_an_table;charset=utf8', 
	'staff', 'password');
foreach ($pdo->query('select * from product') as $row) {
	echo '<form class="ib" action="login.php" method="post">';
